...
Иконки собраны на основе svg пака из [Pixso](https://pixso.net/app/design/OMHorA_MCv1V-96GDDwD7Q?icon_type=1&page-id=0%3A1), поддерживаемого в актуальном состоянии командой дизайнеров DRO. Иконки представлены в размерах: 8, 12, 16, 24, 32, 40, 48.
...
### Обновление иконок
1. Скачиваем актуальный пак svg иконок из [Pixso](https://pixso.net/app/design/OMHorA_MCv1V-96GDDwD7Q?icon_type=1&page-id=0%3A1) с группировкой по размерам (слой Icons)
- ~~Не выделяя листов или иконок~~, нажимаем в сайдбаре справа на кнопку Export
> Выделяем все иконки мышкой 
- В пункте Export нажимаем на `+`
- В раскрывшимся меню выбираем формат иконок SVG
- Нажимаем на три точки (дополнительные настройки) и включаем галочку "Сохранить именованные группы"
...
Hexa UI Icons использует SVRG cli (https://react-svgr.com/) для трансформации svg иконок из Pixso в React компоненты и SVG Optimizer для для оптимизации векторной графики в формате SVG (https://svgo.dev/)
...
### Ресурсы
- [Pixso](https://pixso.net/app/design/OMHorA_MCv1V-96GDDwD7Q?icon_type=1&page-id=0%3A1)
- [StoryBook](https://storybook.s1.ksc-web.avp.ru/icons/?path=/story/icon-gallery--gallery)
