...
([подробнее](?path=/story/docs-конфигурирование-theme-config--docs)) и пропов из `ComponentThemeProps`
([подробнее](?path=/story/docs-типизация-компонентов--docs)).
...
используемые типы были написаны в соответствии с разделом [Типизация компонентов](?path=/story/docs-типизация-компонентов--docs).
