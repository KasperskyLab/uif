...
type PropsType = ReturnType<typeof useUploaderColors>
const fromProps = getFromProps<PropsType>()

export const StyledDragger = styled(Dragger as React.FC<UploadDraggerProps>)`
  &&& {
...
export const StyledFileUploader = styled(Dragger as React.FC<UploadDraggerProps>)`
  &&& {
    border: ${fromProps('normal.border')};
    border-radius: ${BORDER_RADIUS[6]}px;
    background: ${fromProps('normal.background')};
