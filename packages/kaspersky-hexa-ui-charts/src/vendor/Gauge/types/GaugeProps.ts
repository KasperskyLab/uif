...
import { defaultLabels, Labels } from './Labels'
import { defaultPointer, PointerProps } from './Pointer'
...
export const defaultGaugeProps: GaugeProps = {
  id: '',
...
export const getGaugeMarginByType = (type: string): GaugeInnerMarginInPercent | number => {
  const gaugeTypesMargin: Record<string, GaugeInnerMarginInPercent | number> = {
    [GaugeType.GRAFANA]: { top: 0.12, bottom: 0.0, left: 0.07, right: 0.07 },
    [GaugeType.SEMICIRCLE]: { top: 0.08, bottom: 0.0, left: 0.08, right: 0.08 },
    [GaugeType.RADIAL]: { top: 0.07, bottom: 0.0, left: 0.07, right: 0.07 }
  }
