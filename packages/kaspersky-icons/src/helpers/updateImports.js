...
const indexTemplate = (icon) => `import * as Icons${icon} from './${icon}'
export * as Icons${icon} from './${icon}'
export type TypeIcons${icon} = Exclude<keyof typeof Icons${icon}, 'default'>
`
