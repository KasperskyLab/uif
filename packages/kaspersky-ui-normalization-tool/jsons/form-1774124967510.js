/**
 * Демо-форма: сверху сетка 2×2 (text / input для кнопок / button),
 * снизу таблица 2×3 с тулбаром и table.config-hook.
 * Поле `demo-button-text-source` одно на всю форму — все button.config-hook читают его.
 */
export default {
