import{r as t}from"./iframe-zz6a49H8.js";const e=`
...
`;function i(){t.useEffect(()=>{try{if(!document.querySelector("head > style.hexa-ui-dynamic-styles")){const n=document.createElement("style");n.className="hexa-ui-dynamic-styles",n.textContent=e,document.head.appendChild(n),console.info("Hexa UI: set dynamic global styles")}}catch(n){console.error("Hexa UI: failed to set dynamic global styles. The reason is: "+n)}},[])}export{i as u};
