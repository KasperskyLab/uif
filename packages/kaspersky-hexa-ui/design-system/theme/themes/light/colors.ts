import { componentColorsShortcuts, productColorsShortcuts } from '@kaspersky/hexa-ui-core/colors/js'
...
export const colors = {
  ...
  ...componentColorsShortcuts.light,
  product: productColorsShortcuts.light
}
