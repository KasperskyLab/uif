...
import { DateTimeFilterValue, FilterConfigInternal, FilterOperation, FilterType } from '../Filters'
import { isMultipleOp, isRangeValue } from '../Filters/helpers'

import { getFilterOperations } from './helpers'
import { FilterItemConditionProps } from './types'

export function FilterItemCondition <T extends TableRecord = TableRecord> ({
  handleFilterChange,
  filter,
  operations,
  index
