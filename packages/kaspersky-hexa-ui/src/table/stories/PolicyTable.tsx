...
const policyTableArgs: ITableProps = {
...
const policyTableDecorators: Story['decorators'] = [(StoryComponent, context) => (
  <Wrapper>
...
export const PolicyTable: Story = {
  args: policyTableArgs,
  decorators: policyTableDecorators
}
