...
const draggableRows = basicDataSource.slice(0, 8)

const draggableDataSource = [
  ...draggableRows,
  {
    ...draggableRows[7],
    name: "I'm not draggable row",
    description: 'Use _outOfDndContext: true to do this',
    key: 10,
    _outOfDndContext: true
  },
  {
    ...draggableRows[6],
    name: "I'm disabled row",
    description: 'Use _disabled: true to do this',
    key: 9,
    _disabled: true
  }
]
...
export const Draggable: Story = {
  render: (args: ITableProps) => {
    const [dataSourceState, setDataSourceState] = useState(draggableDataSource)
    return (
      <Wrapper>
        <Table
          {...args}
