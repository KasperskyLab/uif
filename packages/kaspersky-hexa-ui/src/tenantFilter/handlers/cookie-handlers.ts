...
export const getActualSelectedTenantsIds = (allTenantsKeys: string[]): string[] => {
  const selectedTenantsIdsFromCookie = getSelectedTenantsIds()

  return selectedTenantsIdsFromCookie.filter(
...
export const getDefaultSelectedTenantsIds = (allTenantsKeys: string[]): string[] => {
  const actualSelectedTenantsIds = getActualSelectedTenantsIds(allTenantsKeys)

  return isEmpty(actualSelectedTenantsIds) ? allTenantsKeys : actualSelectedTenantsIds
}
