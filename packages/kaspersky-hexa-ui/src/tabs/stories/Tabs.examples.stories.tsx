...
export const WithExtraContent: Story = { render: (args) => <Space gap={16}><H3>Отступы и другие стили временно необходимо задавать вручную, в будущем будет проработано со стороны дизайна</H3><Tabs {...args} tabBarExtraContent={RightButton} /> <Tabs {...args} tabBarExtraContent={{ right: RightButton, left: LeftButton }} /></Space> }
...
const StretchedTabs = styled(Tabs)`margin-top: 15px; flex: 1 0 auto;`
