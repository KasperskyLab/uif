...
import { ScheduleTimeColumn } from './components/ScheduleTimeColumn'
import { checkCellInSelectedArea, parseInitialSchedule, toInitialFormat } from './helpers'
import {
  Coordinate,
  WeeklyScheduleProps,
  WeeklyScheduleViewProps
} from './types'
import { useThemedWeeklySchedule } from './useThemedWeeklySchedule'
...
const WeeklyScheduleView: FC<WeeklyScheduleViewProps> = ({
  initialState,
  onChange,
  daysOfWeek,
  legend,
