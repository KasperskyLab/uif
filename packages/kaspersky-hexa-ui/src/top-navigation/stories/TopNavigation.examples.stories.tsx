...
import { topNavigationStorySettings } from './TopNavigation.stories'
...
const defaultAccountMenuOverlay: DropdownItemProps[] = [
  ...
  { title: '© 2025 AO Kaspersky Lab', type: 'group', children: [] }
]
...
const meta = {
  title: 'Hexa UI Components/TopNavigation/Stories',
...
export const WithCenteredElementButton: Story = {
  args: {
    elementCentered: {
      ...
      buttonConfig: {
        title: 'New workspace',
        buttonProps: { mode: 'secondary', iconBefore: <Browser />, iconAfter: <ArrowDown1 /> },
        dropdownMenuProps: { overlay: centerElementOverlay }
      }
    }
  },
  ...
  args: {
    elementCentered: {
      ...
      horizontalNavigationConfig: {
        items: [
          { label: 'Workspaces', selected: true, key: 'workspaces' },
...
export const WithContentRight: Story = {
  args: {
    contentRight: (
      <Tag icon={<Advertisement />} mode="yellow" outlined style={{ marginRight: 0 }}>
