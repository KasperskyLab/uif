...
export const submenuItemTitleDesignPropPresentation: PropPresentationMap = {
  text: { label: '✏️ text', description: 'Текст заголовка группы', type: 'Text', defaultValue: 'Navigation item' },
  elementAfter: { description: 'Отображает элемент после текста заголовка, слева от action', type: 'Boolean', defaultValue: 'false' },
  elementAfter_: { label: '🔄 elementAfter', description: 'Заменяет элемент после текста заголовка', type: 'Instance Swap' },
  action: { description: 'Отображает действие у заголовка', type: 'Boolean', defaultValue: 'false' },
