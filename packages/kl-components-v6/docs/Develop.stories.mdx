...
However, if the developed component can be found in scenarios of other products, it makes sense to transfer it to a single registry (package @kl/components) so that all involved teams can reuse common developments.
