import{b as a,R as e,H as c}from"./iframe-DijVn6lr.js";import{w as m}from"./withMeta-Cvuu-gnO.js";import{G as r}from"./Grid-CCWRtDLv.js";import"./preload-helper-C1FmrZbK.js";import"./StatusOkOutline-rTkgZuSC.js";const l={designTokens:!0,useThemedHook:!0,unitTests:!0,screenshotTests:!1,migration:!0,apiTable:!0,storybook:!0},p="Grid",u="Компонент для композиции элементов на странице с помощью грид системы",g="Расположение элементов на странице и внутри самостоятельных блоков",y={dod:l,component:p,description:u,usage:g},x={title:"Hexa UI Components/Layout/Grid",component:r,argTypes:{cols:{control:{type:"number",min:1}},layoutProperty:{control:"object"}},args:{layoutProperty:{gap:"grouped"},testId:"grid-test-id",klId:"grid-kl-id"},parameters:{badges:[a.stable,a.reviewedByDesign],docs:{page:m(y)}}},b=c.div`
  width: 100%;
  height: 100%;
