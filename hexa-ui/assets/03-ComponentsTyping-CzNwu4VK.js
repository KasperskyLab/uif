import{j as e,M as c}from"./blocks-yA_hxWl_.js";import{useMDXComponents as s}from"./index-CUlJxhH5.js";import"./preload-helper-Dp1pzeXC.js";import"./iframe-4-PRSI1I.js";function r(n){const o={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Docs/Типизация компонентов"}),`
...
`})}),`
`,e.jsxs(o.p,{children:["Используйте тип ",e.jsx(o.code,{children:"TextSizes"}),", если в ",e.jsx(o.code,{children:"FlowerSizeConfig"})," будут размеры шрифта."]})]})}function t(n={}){const{wrapper:o}={...s(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(r,{...n})}):r(n)}export{t as default};
