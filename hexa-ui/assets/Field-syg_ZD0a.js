import{a1 as R,a0 as H,w as M,u as S,R as t,j as k,A,aj as j,H as D}from"./iframe-CBNIXqWm.js";import{F as W}from"./FormLabel-Cy2q2kGk.js";import{H as _}from"./HelpMessage-ur0yPu5r.js";import{M as P}from"./Markdown-CxshTH5T.js";import{P as B}from"./Popover-BHGhJBJm.js";import{o as G}from"./Help-vj8qnM9G.js";const l={p_6:"6fr",p_8:"8fr",p_12:"12fr",p_3_6:"3fr 6fr",p_4_6:"4fr 6fr",p_3_8:"3fr 8fr",p_4_8:"4fr 8fr"},q="872px",p="235px",O="200px",U=[".ant-input",".ant-input-affix-wrapper",".ant-input-number",".ant-input-password","div > .kl-v6-textarea","div > .ant-select","div > .ant-picker",".ant-picker",".kl6-code-viewer",".ant-btn",".kl6-segmented-button",".hexa-upload",'label[class*="toggleBtn"]'],V=[".kl6-checkbox-wrapper",".ant-checkbox-group",".ant-radio-group"],ie=[".kl6-link",".kl6-status",".kl6-text"],X=U.map(e=>`.kl6-field-control-box ${e}`).join(", "),z=V.map(e=>`.kl6-field-control-box > ${e}`).join(", "),J=R();function i(e){return`
    max-width: none;
