import{L as k}from"./Loader-B40QQF8n.js";import{aF as F,H as p,S as c,R as s,$,r as e,y as z,A as v,aG as h}from"./iframe-DVE_7kq9.js";import{t as x,l as B,o as q,a as N}from"./StatusDangerOutlineSquare-Du_eJu5D.js";import{u as S}from"./useTranslation-2jIOXqSO.js";const C=()=>["B","KB","MB","GB","TB","PB"],R=r=>{const t=C();let o=r,l=0;for(;o>1024&&l<t.length-1;)l+=1,o/=1024;const a=o.toFixed(2),d=o.toFixed(0);return`${+a-Math.floor(+a)===0?d:a} ${t[l]}`};function W(r){const t=r.match(/(.){5}(\.[^.]*)?$/);if(t){const o=t[0];return[r.slice(0,-o.length),o]}return[r,""]}const n=F().file,L=p.div`
  display: flex; 
  white-space: pre;
  word-break: keep-all;
`,U=p.div`
