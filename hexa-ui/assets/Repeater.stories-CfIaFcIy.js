import{R as n,b as o,H as l}from"./iframe-DiWy1KYN.js";import{w as u}from"./withMeta-Bxi4FJS3.js";import"./preload-helper-C1FmrZbK.js";import"./Grid-BI9kXhG1.js";import"./StatusOkOutline-CVg5KvZR.js";const s=({component:e,data:t})=>n.createElement(n.Fragment,null,Array.isArray(t)&&typeof e=="function"&&t.map((a,y)=>e({key:y,...a})));s.__docgenInfo={description:"",methods:[],displayName:"Repeater",props:{component:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},data:{required:!0,tsType:{name:"Array",elements:[{name:"any"}],raw:"Array<any>"},description:""}}};const g="Повторяет компонент несколько раз.",N={description:g},R=l.div`
  width: 700px;
