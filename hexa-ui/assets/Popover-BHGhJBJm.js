import{aL as b,a2 as $,a3 as w,w as x,r as R,R as r,aM as T,aN as L,j as y}from"./iframe-CBNIXqWm.js";var S=function(e){if(!e)return null;var o=typeof e=="function";return o?e():e};const N={bottom:{offset:[0,-1]},left:{offset:[1,0]},right:{offset:[-1,0]},top:{offset:[0,1]},topLeft:{offset:[0,0]},topRight:{offset:[0,0]},bottomLeft:{offset:[0,0]},bottomRight:{offset:[0,0]},leftTop:{offset:[0,0]},leftBottom:{offset:[0,0]},rightTop:{offset:[0,0]},rightBottom:{offset:[0,0]}},i=12,l=4.25,k=(t,e,o)=>{const a=b($(w.BTR3));return`
  .${e} .ant-popover-inner {
    min-width: 240px;
    min-height: 52px;
