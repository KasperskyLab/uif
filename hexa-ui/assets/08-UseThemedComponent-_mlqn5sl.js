import{j as e,M as d}from"./blocks-yA_hxWl_.js";import{useMDXComponents as r}from"./index-CUlJxhH5.js";import"./preload-helper-Dp1pzeXC.js";import"./iframe-4-PRSI1I.js";function s(n){const o={a:"a",code:"code",h1:"h1",h2:"h2",h4:"h4",h5:"h5",li:"li",ol:"ol",p:"p",pre:"pre",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Docs/Использование useThemedComponent"}),`
...
`})}),`
`,e.jsx(o.h4,{id:"53-будет-дополняться",children:"5.3 Будет дополняться"})]})}function p(n={}){const{wrapper:o}={...r(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(s,{...n})}):s(n)}export{p as default};
