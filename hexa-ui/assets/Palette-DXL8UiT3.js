import{r as T,R as a,a6 as u,H as d,Z as m,T as w}from"./iframe-DedYZBTA.js";const y=e=>/^#([A-Fa-f0-9]{3,4}){1,2}$/.test(e),$=(e,i)=>e.match(new RegExp(`.{${i}}`,"g")),v=e=>parseInt(e.repeat(2/e.length),16),B=e=>typeof e<"u"?e/255:1,g=e=>{if(!y(e))return"";const i=Math.floor((e.length-1)/3),c=$(e.slice(1),i),[n,t,l,o]=c.map(v);return`rgba(${n}, ${t}, ${l}, ${String(B(o)).slice(0,3)})`},h=(e,i)=>Object.keys(e).find(c=>e[c]===i&&c.includes("_")),C=d.div`
  display: flex;
  align-items: center;
  gap: 8px;
