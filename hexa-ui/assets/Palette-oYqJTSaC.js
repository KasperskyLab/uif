import{r as E,R as t,J as g,H as d,K as m,T as f}from"./iframe-DDLZRCVO.js";const w=e=>/^#([A-Fa-f0-9]{3,4}){1,2}$/.test(e),y=(e,i)=>e.match(new RegExp(`.{${i}}`,"g")),v=e=>parseInt(e.repeat(2/e.length),16),$=e=>typeof e<"u"?e/255:1,u=e=>{if(!w(e))return"";const i=Math.floor((e.length-1)/3),o=y(e.slice(1),i),[n,r,a,s]=o.map(v);return`rgba(${n}, ${r}, ${a}, ${String($(s)).slice(0,3)})`},h=(e,i)=>Object.keys(e).find(o=>e[o]===i&&o.includes("_")),k=d.div`
  display: flex;
  align-items: center;
  gap: 8px;
