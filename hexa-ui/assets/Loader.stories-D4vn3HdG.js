import{T as _}from"./Palette-DqJNg_8n.js";import{b as p,B as e,R as a,c as H,H as w}from"./iframe-DWiAMwiJ.js";import{w as A}from"./withMeta-B2KnXlKz.js";import{s as B}from"./helpers-BytZKRkB.js";import{L as m}from"./Loader-BAjDiBRp.js";import"./preload-helper-C1FmrZbK.js";import"./Grid-BdvuFLTH.js";import"./StatusOkOutline-DhcbM8A-.js";import"./index-DP9ivqwc.js";import"./type-C6K9kL-Y.js";const D={designTokens:!0,useThemedHook:!0,unitTests:!0,screenshotTests:!1,migration:!0,apiTable:!0,storybook:!0,pixsoView:!0},P="Loader",V="В качестве основы используется AntdSpin из библиотеки Antd.",$="Компонент отвечающий за загрузку и запуск новых процессов",I="https://pixso.net/app/design/_JQDYkYJW0yUZVsKeoSybw?icon_type=1&page-id=33851%3A105411",J="https://pixso.net/app/design/d3TkLc_A__Df0mBKigHugA",l={dod:D,component:P,description:V,usage:$,designLink:I,pixsoView:J},G={title:"Hexa UI Components/Loader",component:m,argTypes:{...B(["theme","tip"]),size:{control:"select",options:[e.ExtraSmall,e.Small,e.Medium,e.Large,e.ExtraLarge]}},args:{testId:"loader-test-id",klId:"loader-kl-id"},parameters:{badges:[p.stable,p.reviewedByDesign],docs:{page:A(l)},design:l.pixsoView}},t={},n={render:r=>a.createElement("div",{style:{height:"calc(100vh - 16 * 2px)"}},a.createElement(m,{...r})),args:{centered:!0}},M=w.div`
  display: flex;
  gap: 12px;
`,K=w.div`
  padding: 8px;
