import{j as e,M as l}from"./blocks-yA_hxWl_.js";import{useMDXComponents as r}from"./index-CUlJxhH5.js";import"./preload-helper-Dp1pzeXC.js";import"./iframe-4-PRSI1I.js";function s(o){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...r(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Docs/Конфигурирование THEME_CONFIG"}),`
...
`})}),`
`,e.jsxs(n.p,{children:["Что в дальнейшем будет использовано в ",e.jsx(n.code,{children:"useThemedFlower"})," хуке для получения ",e.jsx(n.code,{children:"cssConfig"})," для компонента."]})]})}function h(o={}){const{wrapper:n}={...r(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(s,{...o})}):s(o)}export{h as default};
