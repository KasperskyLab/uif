...
Итерация 16.04:
    ...
    3.4.4. ✅ вынести биндинг к данных в UI, передавать это свойство модели в конфигхук компонента — план: [plan-form-model-binding.md](./plans/plan-form-model-binding.md)
    3.4.5. вынести настройки disabled, visible в UI, сделать биндинг к данным
